...
public interface UserRepository extends CrudRepository<User, Integer> {
	...
	@Query("SELECT U.fname as fname, U.lname as lname, U.its as its, U.createdDate as createdDate FROM User U WHERE U.razaStatus.razaReceived = 0 order by U.createdDate")
